...
data_mat=data_mat(1:size(data_mat,1),:);
i=1;
...
Full_path = 'C:\<USER>\Downloads\dataSet\Joy\';
...
save([Full_path 'demo_homing_' zeros_ num2str(k) '.mat'], 'Topic', 'parameters' , 'Time' , 'rotational_vel_set' ,'rotational_vel_robot' ,  'translational_vel_set', 'translational_vel_robot' , 'curveture' , 'local_pose_x' , 'local_pose_y' , 'robot_pose_x' ,'robot_pose_y' ,'Orientation');
end
