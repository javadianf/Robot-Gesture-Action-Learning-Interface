...
%angle, joint_parse , conversion3d2d

clear all;
close all;
reply = input('Please enter the file name(TXT): ', 's');
joint_positions = joint_parse(reply);
head_position = (conversion3d2d( joint_positions(:,:,1 )))';
torso_position = (conversion3d2d( joint_positions(:,:,3 )))';
left_hand_position = (conversion3d2d( joint_positions(:,:,6 )))';
right_hand_position = (conversion3d2d( joint_positions(:,:,9 )))';
neck_position = (conversion3d2d( joint_positions(:,:,2 )))';
